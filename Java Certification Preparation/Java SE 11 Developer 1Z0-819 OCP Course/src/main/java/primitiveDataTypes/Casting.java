...
public class Casting {
    public static void main(String[] args) {
        ...
        for (int i = minValue; i <= maxValue; i++) {
            ...
            // We know because of the way we've written the code that i will never be outside the range of a short, so we confidently cast i to s2 as a short.
            ...
            // We need to pass a short to the method we've created so we pass s2, not our loop variable i.
